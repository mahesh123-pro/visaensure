...
import { GraduationCap, Briefcase, Plane, Scale, ArrowUpRight } from "lucide-react";
...
const services = [
    {
        title: "Study",
        description: "Seamless visa services to top global universities and institutions.",
        icon: GraduationCap,
    ...
    {
        title: "Work",
        description: "Hassle-free work visa solutions for leading opportunities worldwide.",
        icon: Briefcase,
    ...
    {
        title: "Migrate",
        description: "Expert guidance for smooth and stress-free migration services.",
        icon: Scale,
    ...
    {
        title: "Tourism",
        description: "Tourist visa assistance tailored to travel dreams.",
        icon: Plane,
